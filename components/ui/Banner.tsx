...
const Banner = () => {
  return (
    <section className="relative container my-10 flex items-center justify-center">
      ...
      <article
        data-aos="fade-down"
        className="absolute top-16 right-0 bottom-0 left-0 z-50 flex flex-col items-center gap-4 text-white"
      >
